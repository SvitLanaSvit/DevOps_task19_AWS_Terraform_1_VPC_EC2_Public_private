...
![Крок 1: Натисніть Create access key](Screens/1.1_create_access_key.png)
...
![Крок 2: Оберіть CLI призначення](Screens/1.2_create_access_key.png)

### 2.3 Додавання опису
1. **Введіть опис** (наприклад: "Terraform development keys")
2. **Натисніть "Create access key"**

![Крок 3: Додайте опис ключа](Screens/1.3_create_access_key.png)
...
![Крок 4: Збережіть обидва ключі](Screens/1.4_create_access_key.png)
